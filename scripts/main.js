...
function compute()
{
    ...
    result.innerHTML = "<br><p>If you deposit  <mark> "+ principal.value +"</mark><br>an interest rate of <mark>" + rate.value + "%</mark> <br>You will receive an amount of <mark>"+interest+"</mark> <br>in the year <mark>"+yearInFuture+"</mark></p>";
